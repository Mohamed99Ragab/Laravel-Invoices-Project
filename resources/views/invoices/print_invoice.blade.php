                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <img src="{{asset('assets/img/invo-logo.png')}}" style="width: 50px;height: 50px;margin-bottom: 15px ">
                                <h6>شركة الجويلي للبرمجيات</h6>
                                <p>مصر - بني سويف - الفشن<br>
                                    رقم الهاتف: 201016207635+<br>
                                    الايميل الكتروني: mohamedragabelgwile010@gmail.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>رقم الفاتورة</span>
                                    <span>{{ $invoice->invoice_num }}</span></p>

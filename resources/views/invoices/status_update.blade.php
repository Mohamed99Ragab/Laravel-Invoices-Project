...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('statusUpdate')}}" method="post" enctype="multipart/form-data"
                          autocomplete="off">
                        @csrf

                        {{-- 1 --}}
                        <input type="hidden"value="{{$invoice->id}}"name="inovice_id">
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">رقم الفاتورة</label>
                                <input type="text" class="form-control" value="{{$invoice->invoice_num}}" id="inputName" name="invoice_number"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input readonly type="text" class="form-control form-control-lg" id="Amount_Commission" value="{{$invoice->amount_commission}}"
                            ...
                            <div class="col">
                                ...
                                <select readonly disabled name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input readonly type="text" value="{{$invoice->value_vat}}" class="form-control" id="Value_VAT" name="Value_VAT" readonly>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">الاجمالي شامل الضريبة</label>
                                <input readonly type="text" value="{{$invoice->total}}"  class="form-control" id="Total" name="Total" readonly>
                            </div>
                        </div>

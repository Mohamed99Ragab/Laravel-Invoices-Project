            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    @if(!empty(auth()->user()->photo))
                        <img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('attachments/users/'.auth()->user()->photo)}}"><span class="avatar-status profile-status bg-green"></span>
                    @else
                        <img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/avatar.png')}}"><span class="avatar-status profile-status bg-green"></span>
                    @endif
                </div>
                <div class="user-info">
                    @if(Auth::check())
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    @can('تقرير الفواتير')
                    <li><a class="slide-item" href="{{ url('/' . $page='invoices_roports') }}">تقارير الفواتير</a></li>
                    @endcan
